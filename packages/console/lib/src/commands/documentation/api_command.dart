...
class ApiCommand extends MelosCommand {
  @override
  String get name => 'api';
  ...
  String get signature =>
      'api {--scope=* : Only generate documentation for packages matching the given name pattern} {--concurrency=1 : Number of packages to process concurrently}';
