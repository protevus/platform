...
class DocsServeCommand extends MelosCommand {
  @override
  String get name => 'docs:serve';
  ...
  String get signature =>
      'docs:serve {--scope=* : Only serve documentation for packages matching the given name pattern} {--port=8080 : Port to serve documentation on}';
