...
class ListDartFilesCommand extends MelosCommand {
  @override
  String get name => 'list:dart:files';
  ...
  String get signature =>
      'list:dart:files {--scope=* : Only list files for packages matching the given name pattern} {--relative : Show paths relative to package root} {--generated : Include generated files}';
