...
class HotReloader {
  ...
  /// Invoked to load a new instance of [Application] on file changes.
  final FutureOr<Application> Function() generator;
  ...
  void sendError(HttpRequest request, int status, String title_, e) {
    ...
    response.headers
      ...
      ..set(HttpHeaders.serverHeader, 'platform');
